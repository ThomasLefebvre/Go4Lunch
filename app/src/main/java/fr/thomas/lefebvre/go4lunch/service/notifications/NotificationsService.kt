...
class NotificationsService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {// token singleton
...
//            .setStyle(inboxStyle)
    ...
    private fun checkNotificationIsActived() {// test if notification user is actived
    ...
    private fun getInfosForNotification(idRestaurant: String) {//get infos for build notifications
        ...
        userHelper.getUserByPlaceId(idRestaurant)
            .addOnSuccessListener { documents ->
                ...
                messageNotif =
                    (getString(R.string.notification_title) + " " + restaurantName + " " + restaurantAdresse + " "
